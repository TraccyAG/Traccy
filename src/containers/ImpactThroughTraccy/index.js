...
const ImpactThroughTraccy = () => {
    ...
    useEffect(() => {
        ...
        // Clean up the effect by resetting body overflow to its default value
        return () => {
                            ...
                            >
                                ...
                                >
                                    <div className="page-1-left">
                                        ...
                                        <p>
                                            At Traccy, it is all about creating impact. We build an ecosystem that
                                            enables changemakers to invest quickly and securely in sustainable
                                            innovations, while also providing qualified project owners with the
                                            financing they need. In doing so, we're bridging the gap between funds
                                            seeking projects and projects ready to be funded on a global scale.
                                        </p>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="page-2-right">
                                        <h1>Trigger</h1>
                                        <p>
                                            Based on market research and considering various criteria such as economic
                                            freedom, growth and equity risk in a project country, Traccy Lab selects,
                                            and incubates projects that create innovative solutions to social and
                                            environmental challenges. Traccy Lab provides resources and mentors to help
                                            these projects succeed and strives to foster a culture of impact and
                                            sustainability from idea to implementation.
                                        </p>
                                    </div>
                                ...
                                >
                                    <div className="page-3-left">
                                        <h1>Engage</h1>
                                        <p>
                                            Engage on Traccy Connect by purchasing your tokens and making a commitment
                                            to invest in high-impact projects that address social and environmental
                                            challenges. As a community member, you will have access to project
                                            participation during the launch phase, enabling you to make a positive
                                            impact on the world.
                                        </p>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="page-4-right">
                                        <h1>Connect</h1>
                                        <p>
                                            Stay connected to sustainable impact by monitoring projects and investments
                                            during their execution phase. Collaborate with like-minded community members
                                            and support project owners in their mission to make a positive change on
                                ...
                                <Container>
                                    <div className="stage-wrapper">
                                          ...
                                          {data.application_number > 1 ? "selections" : "selection"}
                                                ...
                                                <div className="project-list-button" onClick={() => onConnect(index)}>
                                                    ...
                                                    <svg width="7" height="13" viewBox="0 0 7 13" fill="none"
                                                        ...
                                                        <rect width="8.56312" height="1.19726" rx="0.59863"
                                                              transform="matrix(0.704076 -0.710124 -0.383266 -0.923638 0.519531 12.2773)"
                                                              fill="white"/>
                                                        <rect width="8.40448" height="1.21272" rx="0.60636"
                                                              transform="matrix(0.735698 0.67731 0.35421 -0.935166 0 1.13477)"
                                                              fill="white"/>
                                                    </svg>
                                                </div>
                                            </div>
                                        ...
                                        <Col sm='12' className='arrow-action'>
                                            <button onClick={() => slider?.current?.slickPrev()}><SvgIcon
                                                name='arrow-left' viewbox='0 0 9.071 16.492'/></button>
                                            <button onClick={() => slider?.current?.slickNext()}><SvgIcon
                                                name='arrow-right' viewbox='0 0 9.073 16.494'/></button>
                                        </Col>
                                    </div>
                                </Container>
                                <section className='map-section'>
                                    ...
                                    <div className='right-numbers'>
                                       ...
                                       <li className="right-2" onClick={() => router.push("/impact-through-traccy-details/green-protocol")}>02</li> */}
                                                    <li className="right-3"
                                                        onClick={() => router.push("/impact-through-traccy-details/traccy-solar")}>01
                                                    </li>
                                                    <li className="right-4"
                                                        onClick={() => router.push("/impact-through-traccy-details/traccy-lab")}>02
                                                    </li>
                                                    <li className="right-5"
                                                        onClick={() => router.push("/impact-through-traccy-details/traccy-farm")}>03
                                                    </li>
                                                </>
                                            }
                                            {/* {index === 1 &&
                                    <li className="right-6" onClick={() => router.push("/impact-through-traccy-details/flyout")} >01</li>
                                            ...
                                            {index === 2 &&
                                                <li className="right-7"
                                                    onClick={() => router.push("/impact-through-traccy-details/traccy-connect")}>01</li>
                                            }
                                        </ul>
                                    </div>
                                </section>
