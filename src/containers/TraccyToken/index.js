                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <p className='main-heading-text'>Our business model is supported by the following three pillars</p>
                        </Col>
                    </Row>
                                        ...
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    ...
                                                    <p> Our platform connects investors seeking socially responsible investments and local
                                                        people who bring these projects to life. You will get full access to the platform and
                                        ...
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    ...
                                                    <p>Participate in your preferred project with direct impact, secure and efficient. You will get
                                                        access to all our STO projects and be the first to know about news and insights.<br />&nbsp;</p>
                                                </div>
                                            </div>
                                        </Col>
                                        <Col className='right-col'>
                                        ...
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    ...
                                                    <h3>Voting Power</h3>
                                                    <p>By using your voting power, you can actively shape the direction, priorities and success
                        ...
                        <Col className="desktop">
                            <div className='roadmap-wrapper' ref={roadmapWrapperRef} >
                                <svg className="roadmap-path" width="1334" height="243" viewBox="0 0 1334 243" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g className="roadmap-point" onClick={(e) => e.stopPropagation()} onMouseEnter={(e) => hoverRoadmap(e, 0)} >
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <p style={{textAlign:'center'}}>Traccy Connect enables changemakers to invest quickly and securely in food production,
