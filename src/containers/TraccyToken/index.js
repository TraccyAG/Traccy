...
const InfoModal = () => {
    ...
    return (
        <>
            ...
            <Modal title="19 November" centered footer={null} open={isModalOpen} onOk={handleOk}
...
const TraccyToken = () => {
    ...
    const hoverRoadmap = (e, index) => {
        ...
        const paths = document.getElementsByClassName("roadmap-point")[index].querySelectorAll("path");
        const thirdPath = paths[3];

        if (thirdPath.style.visibility === "hidden") {
            thirdPath.style.visibility = "visible";
        } else {
            thirdPath.style.visibility = "hidden";
        }
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < points.length; i++) {
            ...
            const top = childRect.top - parentRect.top + 40;// - descs[i].clientHeight / 2;
        ...
        <div className='tracytoken-wrapper'>
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <p className='main-heading-text'>Our business model is supported by the following three
                                pillars</p>
                        </Col>
                    </Row>
            ...
            <section className='csp-section'>
                ...
                <Container>
                    <Row>
                        <Col>
                            <h1 className='main-heading text-center'><span>Features</span></h1>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                                    ...
                                    <Row>
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    <div className='icon-circle'>
                                                        <SvgIcon name='community-access-icon'
                                                                 viewbox='0 0 76.732 48.846'/>
                                                    </div>
                                                    <h3>Community Access</h3>
                                                    <p> Our platform connects investors seeking socially responsible
                                                        investments and local
                                                        people who bring these projects to life. You will get full
                                        ...
                                        <Col className='right-col'>
                                            <img className='center-image' src="/traccy-token/community-access.gif"
                                                 alt='line'/>
                                        </Col>
                                    </Row>
                                </div>
                                    ...
                                    <Row>
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    <div className='icon-circle'>
                                                        <SvgIcon name='staking-rewards-icon'
                                                                 viewbox='0 0 63.185 49.33'/>
                                                    </div>
                                                    <h3>Direct Participation</h3>
                                                    <p>Participate in your preferred project with direct impact, secure
                                                        and efficient. You will get
                                                        access to all our STO projects and be the first to know about
                                                        news and insights.<br/>&nbsp;</p>
                                                </div>
                                            </div>
                                        </Col>
                                        <Col className='right-col'>
                                            <img className='center-image' src="/traccy-token/direct-participant.gif"
                                                 alt='line'/>
                                        </Col>
                                    </Row>
                                </div>
                                        ...
                                        <Col className='left-col'>
                                            ...
                                            <div className='left-bottom'>
                                                <div>
                                                    ...
                                                    <h3>Voting Power</h3>
                                                    <p>By using your voting power, you can actively shape the direction,
                                                        priorities and success
                                                        of the projects through the platform.</p>
                                                </div>
                                            </div>
                                        </Col>
                                        <Col className='right-col'>
                                            <img className='center-image' src="/traccy-token/voting-power.gif"
                                                 alt='line'/>
                                        </Col>
                                    </Row>
                                </div>
                    ...
                    <Row>
                        <Col>
                            ...
                            <p style={{
                                ...
                                color: '#bdb5b5',
                                lineHeight: ' 1.5'
                            }}>Traccy Connect enables changemakers to invest quickly and securely in food production,
                                green energy and water supply. Our secure and traceable platform using blockchain
                                technology ensures transparency and efficiency throughout the investment process.</p>
