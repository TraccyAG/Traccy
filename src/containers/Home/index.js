    ...
    return (
        ...
        >
            <svg width="7" height="9" viewBox="0 0 7 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.55542 1.52734L4.75181 4.72374L1.73367 7.74188" stroke="white" stroke-width="2"
    ...
    return (
        ...
        >
            <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.71191 8.07715L1.51552 4.88075L4.53366 1.86261" stroke="white" stroke-width="2"
                      stroke-linecap="round"/>
            </svg>
        </div>
    );
                ...
                <div className='home2-wrapper-inner'>
                    ...
                    >
                            ...
                            <div className='home2-slide-card'>
                                ...
                                <div className='slide-icon'>
                                    <svg viewBox="0 0 100 100" className='circle'>
                                        <circle className="background" cx="50" cy="50" r="45" stroke="#803B9B"
                                                fill="transparent" stroke-width="1" pathLength="1" stroke-dasharray="1"
                                                stroke-dashoffset="0"/>
                                        <circle className="foreground" cx="50" cy="50" r="45" transform="rotate(110)"
                                                transform-origin="center" fill="transparent" stroke-width="1"
                                ...
                                <div className='slide-icon'>
                                    <svg viewBox="0 0 100 100" className='circle'>
                                        <circle className="background" cx="50" cy="50" r="45" stroke="#803B9B"
                                                ...
                                                stroke-dashoffset="0"/>
                                        <circle className="foreground" cx="50" cy="50" r="45" transform="rotate(110)"
                                                transform-origin="center" fill="transparent" stroke-width="2"
                                                pathLength="1" stroke-dasharray="1" stroke-dashoffset="1"
                                                stroke-linecap="round"/>
                                    </svg>
                        ...
                        <div onMouseOver={() => slickGoTo(4)} onClick={() => history.push("/become-part")}>
                            <div className='home2-slide-card'>
                                ...
                                <div className='slide-icon'>
                                    ...
                                    <img src="/main-menu/become.gif" className="animation-icon" alt="animation"
                        ...
                        <div onMouseOver={() => slickGoTo(4)}
                             onClick={() => access ? history.push("/invest") : history.push("/login")}>
                            <div className='home2-slide-card'>
                                <div className="home2-slide-overlay"/>
        ...
        <div className="learn-more" {...props}>
            ...
            <div className="left-rect">
                <svg height="100%" viewBox="0 0 150 50">
                    <path transform="scale(-1, 1)" transform-origin="center" stroke="#BE1E73" fill="transparent"
                          stroke-width="3" pathLength="1" stroke-dasharray="1" stroke-dashoffset="0"
                          d="M0 0 h150 v50 h-150"></path>
                </svg>
            </div>
            <div className="right-rect">
                <div style={{width: "201px"}}>
                    <svg height="100%" viewBox="0 0 150 50">
                        <path stroke="#BE1E73" fill="transparent" stroke-width="3" pathLength="1" stroke-dasharray="1"
                              stroke-dashoffset="0" d="M0 0 h150 v50 h-150"></path>
                    </svg>
                </div>
            </div>
            ...
            <div className="arrow">
                <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        d="M0.987319 7.20036C1.53261 7.20036 1.97466 6.75741 1.97466 6.21102C1.97466 5.66462 1.53261 5.22168 0.987319 5.22168C0.442028 5.22168 0 5.66462 0 6.21102C0 6.75741 0.442028 7.20036 0.987319 7.20036Z"
                        fill="white"/>
                </svg>
            </div>
