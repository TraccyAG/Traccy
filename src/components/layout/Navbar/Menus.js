...
const Menus = ({login}) => {
    ...
    return (
        <>
            ...
            >
                <Button className="menu-close" onClick={onClose}><SvgIcon name="close"
                                                                          viewbox="0 0 10.357 10.357"/></Button>
                <ul>
                    <li>
              ...
              Impact
...

                    {
                        ...
                        <li>
                            <Link to='/myProfile'>
                                <div className='menu-icon'>
                                    <img src="/invest-form/icons8-customer-100.png" width="30px" height="30px"
                                         alt="bitcoin"/>
                                </div>
                                My Profile
                            </Link>
                ...
                <ul className="web-menu">
                    ...
                    {access &&
                        <li>
                            <NavLink
                                to='/myProfile'
                                className={`${path.includes("/myProfile") ? "active_m" : ""}`}
                            >
                                My Profile
                            </NavLink>
                        </li>
      ...
      /> */}
            ...
            {
                login &&
                <Button className="menu-icon login" onClick={showDrawer}><SvgIcon name="menu"
                                                                                  viewbox="0 0 28 28"/></Button>
            }
        </>
    );
}
